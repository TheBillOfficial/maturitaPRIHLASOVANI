...
class Container_f27301c638 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\BasePresenter' => [1 => ['application.1', 'application.4', 'application.6']],
			...
			'App\Presenters\PrihlasovaniPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'application.5' => 'App\Presenters\PrihlasovaniPresenter',
	...
	public function createServiceApplication__5(): App\Presenters\PrihlasovaniPresenter
	{
		$service = new App\Presenters\PrihlasovaniPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
